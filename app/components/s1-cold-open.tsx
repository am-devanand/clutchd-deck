    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl items-center gap-16 px-6 md:px-12 lg:flex-row lg:px-16">
        ...
        <div className="flex flex-1 flex-col items-start">
          ...
          >
            <button className="u-btn-grad group relative inline-flex min-h-[44px] items-center justify-center overflow-hidden rounded-full px-8 py-3.5 text-sm font-bold text-white">
            ...
            <button className="inline-flex min-h-[44px] items-center justify-center rounded-full border border-beacon bg-white/70 px-8 py-3.5 text-sm font-bold text-beacon backdrop-blur transition-all hover:bg-beacon hover:text-white">
              {t("ctaSecondary")}
            </button>
          </motion.div>
